...
void pci_scan()
{
                 ...
                 function++)
            {
                    ...
                    subclass == 0x03)
                {
                    if (prog_if == 0x00)
                    {
                        ...
                        Uart::puts(
                            "[PCI] UHCI USB 1.1 controller detected\n"
                        );
                    ...
                    else if (prog_if == 0x10)
                    {
                        ...
                        Uart::puts(
                            "[PCI] OHCI USB 1.1 controller detected\n"
                        );
                    ...
                    else if (prog_if == 0x20)
                    {
                        ...
                        Uart::puts(
                            "[PCI] EHCI USB 2.0 controller detected\n"
                        );
                    ...
                    else if (prog_if == 0x30)
                    {
                        ...
                        Uart::puts(
                            "[PCI] xHCI USB 3.x controller detected\n"
                        );
                    ...
                    else
                    {
                        ...
                        Uart::puts(
                            "[PCI] Unknown USB controller detected\n"
                        );
     ...
     *
     * For now we want USB 2.0 first.
     */

    if (found_ehci)
    {
        Uart::puts(
            "[PCI] Selected controller: EHCI (USB 2.0)\n"
        );
    ...
    {
        Uart::puts(
            "[PCI] Selected controller: OHCI (USB 1.1)\n"
        );
    ...
    {
        Uart::puts(
            "[PCI] Selected controller: UHCI (USB 1.1)\n"
        );
    ...
    {
        Uart::puts(
            "[PCI] Selected controller: xHCI (USB 3.x)\n"
        );
    ...
    {
        Uart::puts(
            "[PCI] No supported USB controller available\n"
        );
...
void pci_init()
{
    ...
    Uart::puts(
        "[PCI] PCI initialization complete\n"
    );
}